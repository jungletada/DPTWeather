...
parser.add_argument('--gt_path', type=str, default='data/kitti/depth', help='root path to the groundtruth data', required=False)
parser.add_argument('--dataset', type=str, default='kitti', help='dataset to test on, nyu or kitti',)
